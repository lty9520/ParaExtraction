#include "CannyBound.h"

canny_bound::canny_bound(){}
...
//第三个参数sigma是卷积核的标准差
//*************************************************************
void canny_bound::GetGaussianKernel(double **gaus, const int size, const double sigma)
{
...
//*************************************************************
void canny_bound::ConvertRGB2GRAY(const Mat &image, Mat &imageGray)
{
...
//第四个参数size是滤波核的尺寸
//*************************************************************
void canny_bound::GaussianFilter(const Mat imageSource, Mat &imageGaussian, double **gaus, int size)
{
...
//*************************************************************
void canny_bound::SobelGradDirction(const Mat imageSource, Mat &imageSobelX, Mat &imageSobelY, double *&pointDrection)
{
...
//*************************************************************
void canny_bound::SobelAmplitude(const Mat imageGradX, const Mat imageGradY, Mat &SobelAmpXY)
{
...
//*************************************************************
void canny_bound::LocalMaxValue(const Mat imageInput, Mat &imageOutput, double *pointDrection)
{
...
//******************************************************
void canny_bound::DoubleThreshold(Mat &imageIput, double lowThreshold, double highThreshold)
{
...
//第三个参数highThreshold是高阈值
//*************************************************************
void canny_bound::DoubleThresholdLink(Mat &imageInput, double lowThreshold, double highThreshold)
{
	for (int i = 1; i<imageInput.rows - 1; i++)
	{
		for (int j = 1; j<imageInput.cols - 1; j++)
